...
class XSICOREEXPORT CSIBCXfoMatd : private CSIBCMatrix44d
{
	...
	public:
		...
		*/
		...
		/*! A smart matrix decomposition method to handle negative scaling
			\param	out_Scale	Receives the scale components 
					respected.
			\param	out_Rotate	Receives the rotation components. 
					respected.
			\param	out_Trans	Receives the translation components.
		*/
		void GetSmartDecomposition ( CSIBCVector3D& out_Scale, CSIBCVector3D& out_Rotate, CSIBCVector3D& out_Trans ) const;
