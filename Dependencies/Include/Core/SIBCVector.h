...
// Macros
//***************************************************************************************
#define SIBCVECTOR_EPS 0.00001f
	...
	public:     
		...
		*/
		...
		/*! Determines whether this vector and \p i_vVector are orthogonal (at 90 degrees to
			each other). This function uses a floating-point comparison error of #SIBCVECTOR_EPS.
		...
		*/
		...
		/*! Determines whether all of the components of this vector are zero. This function
			uses a floating-point comparison error of #SIBCVECTOR_EPS.
...
{
    if( fabs( GetDot( in_vct ) ) < SIBCVECTOR_EPS) 
        return TRUE;
    else
        return FALSE;
}
...
inline SI_Bool CSIBCVector2D::IsNull() const 
{
    ...
    const SI_Float l_dEpsilon = SIBCVECTOR_EPS;
