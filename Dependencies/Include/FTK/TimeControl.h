...
public:
	...
	*/
	...
	/*! Creates a new ClipToParent and connect it
		\retval CSLXSIClipToParent Pointer to the newly created ClipToParent.
		\retval NULL An ClipToParent already exists.
	*/
    CSLXSIClipToParent* CreateClipToParent();
	
	/*! Gets the ClipToParent
		\retval Pointer to the ClipToParent
		\retval NULL There is no ClipToParent
	*/
	CSLXSIClipToParent* GetClipToParent();

	/*! Sets one of the extrapolation position
		\param in_pClipToParent The ClipToParent to set
	...
	*/
	...
	/*! Sets the ClipToParent values if not already set
		\param in_pClipToParent ClipToParent to connect
