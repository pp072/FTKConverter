...
/*!
   \file Template.h
   \brief CSLTemplate class declaration.
*/
/******************************************************************************\
*
* File:          Template.h
...
public:
	...
	*/
	...
	\return	CSLCustomPSet*	the found custom pset
	*/
	...
	*/
	...
	/*!	Return the object's fullname (XSI path).
		\return	SI_Char*	Pointer to a string containing the object's fullname (XSI path).
	*/
	...
	*	\return CSLXSIUserKeyword*	The CSLXSIUserKeyword object if it exists, NULL if not.
	*/
	CSLXSIUserKeyword* GetUserKeyword();

	/*! Creates a CSLXSIUserKeyword object
	*	\return CSLXSIUserKeyword*	The CSLXSIUserKeyword object
	*/
	CSLXSIUserKeyword*	CreateUserKeyword();

	/*! Connect an existing CSLXSIUserKeyword object to the template
		\param	CSLXSIUserKeyword*	The new CSLXSIUserKeyword
		\return CSLXSIUserKeyword* The old CSLXSIUserKeyword
	*/
	...
	*/
	...
	/*! Checks if the version of dotXSI file exports with full names (e.g. "model.name") or just the name
		\return SI_Bool	 True if the full name is exported for this version
	*/
