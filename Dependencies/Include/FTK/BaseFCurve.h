...
/**
* Describes a bezier fcurve key.
*/
struct CSLBezierKey : public CSLBaseKey
{
	SI_Float m_fInTangentX;
	SI_Float m_fInTangentY;
	SI_Float m_fOutTangentX;
	SI_Float m_fOutTangentY;
};
...
public:
	...
	*/
	typedef CSLArrayProxy<CSLBezierKey, SI_Float, 6> CSLBezierKeyArray;
	...
	*/
	...
	/*!	Returns an array of bezier fcurve keys.
		\retval	CSLBezierKeyArray*	Array of bezier fcurve keys.
		\retval NULL Invalid interpolation type.
		\sa CSLBaseFCurve::GetInterpolationType
	*/
	CSLBezierKeyArray* GetBezierKeyList();
	...
	*/
	...
	/*!	Returns an array of bezier fcurve keys.
		...
		\sa CSLBaseFCurve::GetInterpolationType
	*/
	CSLBezierKey* GetBezierKeyListPtr();
...
private:
	...
	union
	{
		...
		CSLBezierKeyArray* m_pBezierKeys;
