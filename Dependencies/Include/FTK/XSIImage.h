...
public:
	...
	*/
	...
	/*! Destroys the Image FX 2
		\return SI_Error Whether or not the ImageFX2 could be destroyed
	*/
	SI_Error DestroyImageFX2();

	/*! Connects an exisiting Image FX 2
		\param in_pToConnect Pointer to the ImageFX2 to use
	...
	*/
	...
	/*! Gets a pointer to the Image FX 2
		\return CSLImageFX2 Pointer to the Image FX 2
	*/
